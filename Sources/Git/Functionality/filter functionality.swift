...
public func git_filter_list_load(
    ...
    path: String,
    mode: Filter.Mode,
    flags: Filter.Flag) throws(GitError) {
...
//    {
//        try Writestream.filterBufferedStream(
//            filter: self,
//            writeFunction: crlf_apply,
//            temporaryBuffer: nil,
//            payload: &payload,
//            source: src,
//            target: next)
...
//    @Sendable
//    func crlf_apply(
//    payload: AnyTypeProtocol?, /* may be read and/or set */
//    to: String,
//    from: String,
//    src: Filter.Source)
//    throws(GitError)
...
//    
//    
//    struct BufferedStream: AnyStructProtocol {
//        var parent: any Writestream
//        var filter: Filter
//        var filterWriteFunction: Filter.WriteFunction
//        var legacy_write_fn: LegacyWriteFunction? = nil
//        let source: Filter.Source
//        var payload: AnyTypeProtocol?
//        var input = String()
//        var temporaryBuffer: String? = nil
//        var output: String
//        var target: any Writestream
//    }
//}
//
//
//
//extension Filter.BufferedStream: Writestream {
//    mutating func write(data: String) {
//        String.bufferAppend(buffer: &input, stringToAppend: data)
//    }
//    
//    
//    mutating func close() throws(GitError) {
//        
//        var writebuf: String
//        
//        do {
//            try self.filter.write(to: self)
//        TODO: One of these
//            try self.filterWriteFunction(self.filter)(
//                self.payload,
//                self.output,
//                self.input,
//                self.source)
//            
//            writebuf = self.output;
//        }
//        catch where error.code == .userConfiguredCallbackRefusedToAct {
//            writebuf = self.input
//        }
//        catch {
//            /* close stream before erroring out taking care
...
//        }
//        
//        try self.target.write(data: writebuf)
//        try self.target.close()
//    }
//}
//
//
//
//extension Filter.BufferedStream {
//    @globalActor
//    final actor SyncLock: GlobalActor {
//        public static let shared = ActorType()
//        
//        public typealias ActorType = SyncLock
//    }
//}
//
//
//
//private extension Filter {
//    func write(to bufferedStream: BufferedStream) throws(GitError) {
//        self.filterWriteFunction
//    }
//}
//
//
...
//    // Analogous to `git_filter_buffered_stream_new`
//    static func filterBufferedStream<Target>(
//        filter: Filter,
//        writeFunction: @escaping Filter.FilterWriteFunction,
//        temporaryBuffer: inout String,
//        payload: inout AnyTypeProtocol,
//        source: Filter.Source,
//        target: Target)
//    -> some Writestream
//    where Target: Writestream
//    {
//        temporaryBuffer.removeAll(keepingCapacity: true)
//        
//        let bufferedStream = Filter.BufferedStream(
//            parent: Filter.BufferedStream(),
//            filter: filter,
...
//
//
//@available(*, unavailable, renamed: "Filter.BufferedStream")
//private typealias buffered_stream = Filter.BufferedStream
